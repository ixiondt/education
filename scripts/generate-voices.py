...
PHRASES = {
    ...
    "adv-snowy-1":          "Brrr, it's so cold! Tap how the snow makes you feel.",
    ...
    "adv-birthday-3":       "Birthdays are so exciting! Tap the happy face.",
    "adv-birthday-4":       "Happy birthday! What a great party.",
    "adv-kindness-1":       "A friend needs help. What would YOU do? Tap the kindest answer.",
    "adv-kindness-2":       "Now think about you. Who makes you feel cared for?",
    "adv-kindness-3":       "What does kindness look like? Tap the happy face!",
